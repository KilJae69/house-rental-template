...
import BookingInquiryFields from "./shared/BookingInquiryFields";
...
export function FormModal() {
  ...
  return (
    <div className="flex items-center justify-center">
      <Modal>
        <ModalTrigger className="px-12 py-4 bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-dark)] focus:ring-[var(--color-primary-light)] inline-flex items-center group relative justify-center font-medium rounded-md cursor-pointer transition focus:outline-none focus:ring-2 focus:ring-offset-2 group/modal-btn">
          <span className="group-hover/modal-btn:translate-x-46 text-center transition duration-300">
            {t("formModal.triggerButton")}
          </span>
          <div className="-translate-x-46 group-hover/modal-btn:translate-x-0 flex items-center justify-center absolute inset-0 transition duration-300 text-white z-20">
